<?php
  ...
  if(isset($_POST['submitted'])){
	...
	$q = "select * from lokal where nama='$nama' and id_fak={$_SESSION['adm_fak']} and id_TA={$_SESSION['id_ta']} and id_lkl!=$idl";
	...
	if(!preg_match('/^[0-9]+$/', $muat)){
	  ...
	  $q = "update lokal set nama='$nama', muat=$muat, id_fak={$_SESSION['adm_fak']}, id_univ={$_SESSION['idfu']} where id_lkl=$idl";
	  $r = mysqli_query($dbc, $q);
